...
public class MoonPhase {
    ...
    private static final double MY_TWO_PI = 6.28318530717958647692;
    private static final double EPOCH = 2444238.5; /* 1980 January 0.0. */
    private static final double SUN_ELONG_EPOCH = 278.833540; /*
															 * Ecliptic
															 * longitude of the
															 * Sun at epoch
															 * 1980.0.
    ...
    private static final double SUN_ELONG_PERIGEE = 282.596403; /*
																 ...
																 * perigee.
																 */
    private static final double ECCENT_EARTH_ORBIT = 0.016718; /*
															 * Eccentricity of
															 * Earth's orbit.
															 */
    private static final double MOON_MEAN_LONGITUDE_EPOCH = 64.975464; /*
																	 * Moon's
																	 * mean
																	 * lonigitude
																	 * at the
																	 * epoch.
																	 */
    private static final double MOON_MEAN_LONGITUDE_PERIGREE = 349.383063; /*
																		 * Mean
																		 * longitude
																		 * of
																		 * the
																		 ...
																		 * .
																		 */
    private static final double KEPLER_EPSILON = 1E-6; /*
													 * Accurancy of the Kepler
													 * equation.
													 */
    private static final long RC_MIN_BCE_TO_1_CE = 1721424L; /*
															 * Days between
															 * 1.5-Jan-4713 BCE
															 * and 1.5-Jan-0001
															 * CE
															 */
    public static final double SYNODIC_MONTH = 29.53058868; /*
														 * Synodic month (new
														 * Moon to new Moon)
														 */
    private static final int DAY_LAST = 365;

    private static final boolean orthodox_calendar = false;

    private static final int mvec[] = { 0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334 };
    ...
    private static long cachedMoonLength;
    ...
    public static long getCurrentMoonLength() {
        if (cachedMoonLength == 0) {
            refreshMoonLength();
        }
     ...
     */
    private static int days_of_february(int year) {
        int day;
        if ((year > greg[YEAR])
    ...
    private static int SGN(double gc_x) {
    ...
    public static double phase(double julian_date) {
        ...
        _moonAgeAsDays = SYNODIC_MONTH * (FIXANGLE(moon_present_age) / 360.0);
    ...
    static private double atan(double x) {
