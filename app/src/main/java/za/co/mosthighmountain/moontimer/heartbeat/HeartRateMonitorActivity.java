...
public class HeartRateMonitorActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // TODO switch to FLAG_KEEP_SCREEN_ON
    ...
    public void onResume() {
        ...
        if (camera != null) {
            ...
            previewHolder.removeCallback(surfaceCallback); // disable camera callback

            AlertDialog dialog = new AlertDialog.Builder(HeartRateMonitorActivity.this)
    ...
    private static PreviewCallback previewCallback = new PreviewCallback() {
        ...
        public void onPreviewFrame(byte[] data, Camera cam) {
            ...
            Log.i(TAG, "imgAvg=" + imgAvg + " rolAvg=" + rollingAverage + " type=" + newType.name());
